...
.controller('TokenManagementCtrl', ['$scope', 'TokenAdminState', 'TokenAdminSvc', '$location', '$route', function ($scope, tokenAdminState, tokenAdminSvc, $location, $route) {
    ...
    $scope.tokenSlots = ["BACK", "BEAD", "CHARM", "EAR", "EYES", "FEET", "FIGURINE", "FINGER", "HANDS", "HEAD", "INSTRUMENT", "IOUNSTONE", "LEGS", "MAINHAND", 
        "NECK", "OFFHAND", "POLYMORPH","RUNESTONE", "SHINS", "SHIRT", "SLOTLESS", "TORSO", "WAIST", "WRIST", "SAFEHOLD", "HIRELING", "UNDERLING", "FOLLOWER", "SIDEKICK", "MARK", "PET"];
    $scope.tokenRarities = ["COMMON", "UNCOMMON", "RARE", "ULTRARARE", "ENHANCED", "EXALTED", "RELIC", "LEGENDARY", "ELDRITCH", "PREMIUM", "ARTIFACT", "PLAYER_REWARD", "SAFEHOLD"];
    $scope.tokenConditionals = ["NONE", "DEXTERITY_18", "DEXTERITY_20", "INTELLECT_20", "WISDOM_20", "WEAPON_2H_ANY", "WEAPON_2H", "WEAPON_1H", "WEAPON_RANGED", "WEAPON_RANGED_2H", "MAY_NOT_USE_SHIELDS", "STRENGTH_24", "NOT_WITH_COA", "NO_OTHER_TREASURE", 
        ...
        "NOT_UR_PLUS_RING", "GOBLIN_WEAPON", "DWARF_WEAPON", "NOT_WITH_OTHER_WONDER", "PLUS_1_AC_GOBLIN_WEAPON", "UNCOMMON_OR_BELOW_WEAPON", "LESS_THAN_10_HIT_MELEE", "UNCOMMON_OR_BELOW_WEAPON_RANGE", "NO_OTHER_HAVOC", "NOT_WITH_SOC", "NOT_WITH_ROSS", "DEX_TO_DMG_10"];
